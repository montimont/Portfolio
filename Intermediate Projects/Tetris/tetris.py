...
COLORS = ['black', 'purple', 'green', 'blue', 'yellow', 'red']
...
class Tetris():
    ...
    def apply_tetromino(self):
        ...
        if lines_eliminated > 0:
            chime_sound = pygame.mixer.Sound(
                '/chime.wav')
            chime_sound.play()
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.status_msg = tk.Label(
            self, anchor='w', width=11, font=("Georgia", 24))
        self.status_msg.pack(side="top")
        self.game_over_msg = tk.Label(
            self, anchor='w', width=11, font=("Georgia", 24), fg='red')
