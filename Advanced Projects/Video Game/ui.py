...
class UI:
    ...
    def seletion_box(self, left, top, has_switched):
    ...
    def weapon_overlay(self, weapon_index, has_switched):
        bg_rect = self.seletion_box(10, 630, has_switched)  # for weapon
    ...
    def magic_overlay(self, magic_index, has_switched):
        bg_rect = self.seletion_box(80, 635, has_switched)
